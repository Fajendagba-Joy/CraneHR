                ...
                <div class="card-body">     
                    ...
                    @csrf
                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <h3 class="fw-normal mb-3" style="color: #12456a;">Add Purchase</h3>
                                    ...
                                    <div class="mb-2 pb-2">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" name="grn_no" id="grn_no"
                                                ...
                                                value="{{ old('grn_no') }}" required autocomplete="grn_no">
                                            @error('grn_no')
                                    ...
                                    <div class="mb-2 pb-2">
                                        <div class="form-outline">
                                            ...
                                            <select name="vendor" class="form-control @error('vendor') border border-danger @enderror" id="vendor" required>
                                                @if (isset($vendors))
                                    ...
                                    <div class="mb-2 pb-2">
                                        <div class="form-outline">
                                            ...
                                            value="{{ old('invoice_no') }}" required autocomplete="invoice_no">
                                            @error('invoice_no')
                                                <div class="text-danger error">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="mb-2 pb-2">
                                        <div class="form-outline">
                                            ...
                                            <select name="payment_type" class="form-control @error('payment_type') border border-danger @enderror" id="payment_type" required>
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="mb-2 pb-2">
                                        <div class="form-outline">
                                            ...
                                            value="{{ old('purchase_date') }}" required autocomplete="purchase_date">
                                            @error('purchase_date')
                                                <div class="text-danger error">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <td class="" width="15%">
                                                ...
                                                <div class="mb-2 pb-2">
                                                    <div class="form-outline">
                                                        ...
                                                        value="{{ old('record_total[0][stk_qty]') }}" required autocomplete="stk_qty">
                                            ...
                                            <td class="" width="20%">
                                                ...
                                                <div class="mb-2 pb-2">
                                                    <div class="form-outline">
                                                        ...
                                                        value="{{ old('record_total[0][total]') }}" required autocomplete="total">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    value="{{ old('second_total') }}" required autocomplete="second_total">
                                                    @error('second_total')
                                                        <div class="text-danger error">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <tr>                                            
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    value="{{ old('grand_total') }}" required autocomplete="grand_total">
                                                    @error('grand_total')
                                                        <div class="text-danger error">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    value="{{ old('paid_amount') }}" required autocomplete="paid_amount">
                                                    @error('paid_amount')
                                                        <div class="text-danger error">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    value="{{ old('due_amount') }}" required autocomplete="due_amount">
                                                    @error('due_amount')
                                                        <div class="text-danger error">
                                                            {{ $message }}
                                                        </div>
...
<script type="text/javascript">
    ...
    */
    ...
    $("[name='record_total[0][item_info]']").click(function () {
        var selected = $("[name='record_total[0][item_info]']").val();
        var items = @json($items);
        selected_rate = items.find(item => item.item_info === selected);
        $("[name='record_total[0][rate]']").val(selected_rate.rate);
        $("[name='record_total[0][stk_qty]']").val(selected_rate.stk_qty);
    })
    ...
    $("[name='record_total[0][rate]']").on('keyup mouseup blur',function ()
    {
        var total = "";
        qty = $("[name='record_total[0][qty]']").val();
        total = $("[name='record_total[0][rate]']").val();
        total = total*qty;
        $("[name='record_total[0][total]']").val(total);
    ...
    $("[name='record_total[0][qty]']").on('keyup mouseup',function ()
    {
        var total = "";
        qty = $("[name='record_total[0][qty]']").val();
        total = $("[name='record_total[0][rate]']").val();
    ...
    $("#dynamic-ar").click(function () {
        ...
        $(`[name='record_total[${current_index}][item_info]']`).click(function () {
            ...
            $(`[name='record_total[${current_index}][stk_qty]']`).val(selected_rate.stk_qty);
        });
